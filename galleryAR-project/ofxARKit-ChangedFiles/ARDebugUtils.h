...
namespace ofxARKit {
    ...
    public:
        ...
        void drawDebugInformation(ofTrueTypeFont font){
             ...
             */
            ofDrawCircle(ofGetScreenWidth()/2, ofGetScreenHeight()-20, 50); //LASSI
            ...
            /*switch(trackingStateReason){
                case ARTrackingStateReasonNone:
                    font.drawString("Tracking state: Great!",x,y + 10);
                    
                    break;
                    
                case ARTrackingStateReasonInitializing:
                    font.drawString("Tracking state: Initializing!",x,y + 10);
                    break;
                    
                case ARTrackingStateReasonExcessiveMotion:
                    font.drawString("Tracking state: Excessive Motion!",x,y + 10);
                    
                    break;
                    
                case ARTrackingStateReasonInsufficientFeatures:
                    font.drawString("Tracking state: Bad!",x,y + 10);
                    break;
            }*/
            
            switch(trackingStateReason){
                case ARTrackingStateReasonNone:
                    font.drawString("Tap to place the next image.",x,y + 10);
                    
                    break;
                    
                case ARTrackingStateReasonInitializing:
                    font.drawString("Initializing...",x,y + 10);
                    break;
                    
                case ARTrackingStateReasonExcessiveMotion:
                    font.drawString("Too much motion to place images.",x,y + 10);
                    
                    break;
                    
                case ARTrackingStateReasonInsufficientFeatures:
                    font.drawString("Move the camera around.",x,y + 10);
                    break;
            }
